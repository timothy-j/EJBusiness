...
Imports EJBusiness.Main.My
Imports EJBusiness.Main.ViewModels
Imports EJBusiness.Modules
Imports EJBusiness.Modules.ViewModels
...
#End If
    ...
    Protected Overridable Sub ConfigureNavigation()
        ...
        'AddHandler Manager.GetEvents(Regions.Navigation_Machines).Navigation, AddressOf OnNavigation
