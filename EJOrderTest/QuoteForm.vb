...
Public Class QuoteForm
    ...
    'Private Sub QuoteForm_Closing(sender As Object, e As CancelEventArgs) Handles Me.Closing
    '    If _db.ChangeTracker.HasChanges Then _db.SaveChanges()
    'End Sub
    ...
    'Private Sub QuoteDetailsDataGridView_EditingControlShowing(sender As Object, e As DataGridViewEditingControlShowingEventArgs) Handles QuoteDetailsDataGridView.EditingControlShowing
    '    If TypeOf e.Control Is EJControls.EJComboBoxCellEditingControl Then CType(e.Control, EJControls.EJComboBoxCellEditingControl).OnControlShowing()
    'End Sub
End Class